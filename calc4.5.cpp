...
cout << "jesli dotyczy logarytmu,logarytmu dziesietnego lub pierwiastkow wpisz 0, "<< endl;
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  switch(op) {
   ...
   //potega do wykladnika przypisanego dla num2 
    ...
    //instrukcja default,w chwili pisania komentarzy pojawia sie
    //tylko przy niepoprawnym wyborze operacji
    default:
      cout << "blad";
      break;
  }
